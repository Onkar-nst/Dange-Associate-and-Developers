...
const CustomerDuesReport = () => {
    ...
    if (loading && data.length === 0) return <Layout><div className="flex items-center justify-center min-h-[400px] font-black text-slate-300 uppercase tracking-widest animate-pulse">Syncing EMI Repayment Schedule...</div></Layout>;
